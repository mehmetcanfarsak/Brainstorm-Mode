...
if $UNINSTALL; then
  ...
  rm -f "$CMD_DST/brainstorm.md" "$CMD_DST/brainstorm-done.md"
...
for f in brainstorm.md brainstorm-done.md; do
...
echo "  Commands : $CMD_DST/brainstorm.md, brainstorm-done.md"
echo "  Hooks    : $SETTINGS"
echo ""
